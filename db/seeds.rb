...
Monster.create(name: "Nessie", user:david, species:"Dinosaur", title:"Shy but supportive")
Monster.create(name: "Garou",user:barack, species:"Werewolf", title:"Night only")
